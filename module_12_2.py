...
# Чтобы исправить возможную логическую ошибку, вызванную тем, что участники с меньшей
# скоростью могут финишировать первыми, Вы можете внести изменения в метод start, чтобы можно было
# учитывать скорость участников.
